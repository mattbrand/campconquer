...
public class PositionItem : MonoBehaviour 
{
    ...
    public void Init(DefensePos defensePos)
    {
        ...
        SpriteRend.color = _pulseColor;
        BodySpriteRend.color = Colors.HexToColor(Avatar.Instance.SkinColor);
    ...
    public void Select()
    {
        ...
        BodySpriteRend.enabled = true;
        HairSpriteRend.enabled = true;
        ShirtSpriteRend.enabled = true;
        ShortsSpriteRend.enabled = true;
        _pulseColor.a = 1.0f;
        SpriteRend.color = _pulseColor;
    }
    ...
    public void Unselect()
    {
        ...
        BodySpriteRend.enabled = false;
        HairSpriteRend.enabled = false;
        ShirtSpriteRend.enabled = false;
        ShortsSpriteRend.enabled = false;
