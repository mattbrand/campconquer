...
RSpec.describe OutcomesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested outcome as @outcome" do
      outcome = Outcome.create! valid_attributes
      get :show, {:id => outcome.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested outcome as @outcome" do
      outcome = Outcome.create! valid_attributes
      get :edit, {:id => outcome.to_param}, valid_session
      expect(assigns(:outcome)).to eq(outcome)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Outcome" do
        expect {
          post :create, {:outcome => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved outcome as @outcome" do
        post :create, {:outcome => invalid_attributes}, valid_session
        expect(assigns(:outcome)).to be_a_new(Outcome)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested outcome" do
        outcome = Outcome.create! valid_attributes
        put :update, {:id => outcome.to_param, :outcome => new_attributes}, valid_session
        outcome.reload
      ...
      it "assigns the requested outcome as @outcome" do
        outcome = Outcome.create! valid_attributes
        put :update, {:id => outcome.to_param, :outcome => valid_attributes}, valid_session
        expect(assigns(:outcome)).to eq(outcome)
      end
    ...
    context "with invalid params" do
      it "assigns the outcome as @outcome" do
        outcome = Outcome.create! valid_attributes
        put :update, {:id => outcome.to_param, :outcome => invalid_attributes}, valid_session
        expect(assigns(:outcome)).to eq(outcome)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested outcome" do
      outcome = Outcome.create! valid_attributes
      expect {
        delete :destroy, {:id => outcome.to_param}, valid_session
      }.to change(Outcome, :count).by(-1)
    end
